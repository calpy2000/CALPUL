...
// and, once audited, confirmed here too. drawNeybuzIcon() above is
// UNCHANGED and still the source of truth if this icon's design ever needs
// to change — regenerate images/tile-icon.png from it (e.g. via a headless

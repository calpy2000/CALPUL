// Tenth hand-picked batch — see fetch-new-batch.js for the pattern.
// Usage: TMDB_KEY=xxxx node fetch-new-batch10.js
...
const NEW_TITLES_LOG = path.join(__dirname, 'new-batch10-log.json');

const BATCH = [
  { search: 'Murder on the Orient Express', year: 1974, display: 'Murder on the Orient Express' },
  { search: 'Death on the Nile', year: 1978, display: 'Death on the Nile' },
  { search: 'Belfast', year: 2021, display: 'Belfast' },
  { search: 'The Commitments', year: 1991, display: 'The Commitments' },
];

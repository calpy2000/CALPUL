// Eighth hand-picked batch — see fetch-new-batch.js for the pattern.
// Usage: TMDB_KEY=xxxx node fetch-new-batch8.js
...
const NEW_TITLES_LOG = path.join(__dirname, 'new-batch8-log.json');

const BATCH = [
  { search: 'The French Connection', year: 1971, display: 'The French Connection' },
  { search: 'Kramer vs. Kramer', year: 1979, display: 'Kramer vs. Kramer' },
  { search: 'Billy Elliot', year: 2000, display: 'Billy Elliot' },
  { search: 'Chariots of Fire', year: 1981, display: 'Chariots of Fire' },
  { search: 'Thunderbirds', year: 2004, display: 'Thunderbirds' },
  { search: 'Mad Max', year: 1979, display: 'Mad Max' },
  { search: 'The Expendables', year: 2010, display: 'The Expendables' },
];
